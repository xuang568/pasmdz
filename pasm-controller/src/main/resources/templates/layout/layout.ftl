    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <@shiro.hasPermission name="system:resource:index">
                ...
                <li class="treeview <#if active=="user" || active=="role" || active=="resource" >active</#if>">
                    <a href="#">
                        <i class="fa fa-cog"></i> <span>预查询管理</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
            ...
            <@shiro.hasPermission name="system:pasm:index">
                <li <#if active=="pasm">class="active"</#if>><a href="/pasm/index.ftl"><i class="fa fa-user-o"></i>
                    预授信首次查询</a></li>
            </@shiro.hasPermission>

            <@shiro.hasPermission name="system:pasm:history">
                <li  <#if active=="psam">class="active"</#if>><a href="${ctx!}/pasm/history"><i class="fa fa-user-o"></i>
                    预授信结果查询</a></li>
                ...
                <li id="count" class="treeview <#if active=="user" || active=="role" || active=="resource" >active</#if>">
                    <a href="#">
            ...
            <@shiro.hasPermission name="system:count:index">
                <li <#if active=="resource">class="active"</#if>><a href="${ctx!}/count/index"><i class="fa fa-user-o"></i>
                    预授信统计</a></li>
            </@shiro.hasPermission>
                    </ul>
                </li>
